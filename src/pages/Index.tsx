        ...
        <div className="flex justify-between items-center p-6">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm">
              ...
              <span className="text-gray-300 hover:text-white cursor-pointer">Adults</span>
          ...
          <div className="flex items-center gap-4">
            ...
            <Button variant="ghost" size="icon" onClick={() => setTheme(theme === "light" ? "dark" : "light")} className="text-white hover:bg-white/10">
